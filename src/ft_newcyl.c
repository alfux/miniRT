...
/*   Updated: 2022/12/29 00:27:22 by alfux            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_pars_cyl(t_obj **obj, char *str)
{
	...
	if (ft_coord(&((t_cyl *)(new->obj))->dir, &str)
		|| ((t_cyl *)(new->obj))->dir.x < 0 || ((t_cyl *)(new->obj))->dir.x > 1
		|| ((t_cyl *)(new->obj))->dir.y < 0 || ((t_cyl *)(new->obj))->dir.y > 1
		|| ((t_cyl *)(new->obj))->dir.z < 0 || ((t_cyl *)(new->obj))->dir.z > 1)
		return (4);
