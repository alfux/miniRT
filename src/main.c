...
/*   Updated: 2022/12/21 20:56:12 by alfux            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	cam = ft_setcam(ft_setvec(0, 2, 2), ft_setvec(0, 0.64, -0.76), 90);
	window.scn.cam = &cam;
...
//		ft_exit_failure(&window, "error: object list");
//	ft_objadd(&window.scn.obj, tmp);
	buf = ft_newcyl(ft_setvec(0.f, 0.f, 1.f), ft_setvec(0.f, 1.f, 0.f),
